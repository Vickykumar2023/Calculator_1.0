...
# Cos function system in bacnkig========================================================


    def cos(self):
        self.result=False
        self.current=math.cos(math.radians(float(entry_Display.get())))
        self.display(self.current)
# tan function system in bacnkig========================================================

    def tan(self):
        self.result=False
        self.current=math.tan(math.radians(float(entry_Display.get())))
        self.display(self.current)
# sin function system in bacnkig ========================================================

    def sin(self):
        self.result=False
        self.current=math.sin(math.radians(float(entry_Display.get())))
        self.display(self.current)
...
'''btn_clear=Button(mainFrame,width=6,height=2,font=("arial",16,"bold"),bd=4,text=chr(67),bg="cadetblue")        
btn_clear.grid(row=1,column=1,pady=1)
...
# Right Size Of image in the spacal Character in the Button ==================================================
btn_Squared=Button(mainFrame,width=6,height=2,command=added_value.squared,font=("arial",16,"bold"),bd=4,text="V",bg="cadetblue")        
btn_Squared.grid(row=2,column=0,pady=1)

btn_Cos=Button(mainFrame,width=6,height=2,command=added_value.cos,font=("arial",16,"bold"),bd=4,text="Cos",bg="cadetblue")        
btn_Cos.grid(row=2,column=1,pady=1)

btn_Tan=Button(mainFrame,width=6,height=2,command=added_value.tan,font=("arial",16,"bold"),bd=4,text="Tan",bg="cadetblue")        
btn_Tan.grid(row=2,column=2,pady=1)

btn_Sin=Button(mainFrame,width=6,height=2,command=added_value.sin,font=("arial",16,"bold"),bd=4,text="Sin",bg="cadetblue")        
